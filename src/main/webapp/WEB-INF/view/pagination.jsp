	...
	<ul>
		...
		<c:choose>
			<c:when test="${pagination.curPage > 1}">
				<li><a href="javascript:void(0);" class="page-prev" onclick="pageClick(${pagination.curPage-1})">Last Page</a></li>
			</c:when>
			<c:otherwise>
		...
		<c:choose>
			<c:when test="${pagination.curPage < pagination.pageNumber}">
				<li><a href="javascript:void(0);" class=".page-next" onclick="pageClick(${pagination.curPage+1})">Next Page</a></li>
			</c:when>
			<c:otherwise>
