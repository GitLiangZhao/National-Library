	...
	<div class="caption">
		...
		<form class="form-horizontal modify-book-form" action="modifyBook.do" method="POST">
			...
			<div class="control-group">
				...
				<div class="controls">
					<input value="${book.price }.00" type="text" id="inputPrice" name="priceVo" onblur="validateInput(this)"> <span class="help-inline"></span>
				</div>
			</div>
			<div class="control-group">
			...
			<div class="form-actions">
		    	<a class="btn btn-primary modify-book-submit">Confirm</a>
		    	<button type="reset" class="btn btn-danger modify-book-cancel">Cancel</button>
		    </div>
		</form>
	</div>
</div>
